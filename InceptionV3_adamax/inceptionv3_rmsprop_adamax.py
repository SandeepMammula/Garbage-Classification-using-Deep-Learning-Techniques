# -*- coding: utf-8 -*-
"""InceptionV3_rmsprop_adamax.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pKRs6pXCXVX5TnrSzEMKZsogd9m2N3JL
"""
...
dataset_train = '/content/drive/MyDrive/garbage_dataset/train'
dataset_test = '/content/drive/MyDrive/garbage_dataset/test'
...
checkpoint_callback = ModelCheckpoint(filepath="./best_model.h5",
                                      ...
                                      mode='min',  # Save the model with minimum loss
...
# Define ModelCheckpoint callback to save the best model based on training loss and accuracy
checkpoint_callback = ModelCheckpoint(filepath="./best_model_adamax.h5",
